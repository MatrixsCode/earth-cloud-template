...
public enum ResultEnum {
    ...
    SERVICE_UNAVAILABLE_ERROR(50009, "授权服务未启动"),

    OAUTH2_UNAUTHORIZED_CLIENT_ERROR(70001, "客户端认证失败"),
    OAUTH2_UNSUPPORTED_GRANT_TYPE(70002, "不支持的认证模式"),
    OAUTH2_INVALID_SCOPE_ERROR(70003, "非授权范围"),
    OAUTH2_PARAMETER_ERROR(70004, "参数异常"),


    ACCESS_UNAUTHORIZED(6001, "访问未授权"),
    TOKEN_INVALID_OR_EXPIRED(6002, "Token令牌无效或已过期"),
    TOKEN_ACCESS_FORBIDDEN(6003, "Token令牌已被禁止访问"),
